  ...
  private lineupPage(score: ReturnType<ClubSimulation["score"]>, selected: Player | null) {
    ...
    return `
      ...
      <section class="tactical-console tactical-card">
        ...
        <div class="system-readiness-console"><span class="card-kicker">SYSTEM ADAPTATION</span><div><p>${this.simulation.formation.label}での平均実力発揮率</p><small>選手ごとのシステム理解力と、この布陣での試合・練習経験から算出。</small></div><b>${score.systemRate}<small>%</small></b></div>
